...
<body onload="document.linkAjaRedirect.submit();">
	<div>
		<form id="linkAjaRedirect" name="linkAjaRedirect" role="form" class="form-horizontal" action="/payment/linkAjaForm" method="POST" modelAttribute="linkaja">								
