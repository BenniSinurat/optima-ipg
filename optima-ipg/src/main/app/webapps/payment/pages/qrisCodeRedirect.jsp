...
<body onload="document.qrisCodeRedirect.submit();">
	<div>
		<form id="qrisCodeRedirect" name="qrisCodeRedirect" role="form" class="form-horizontal" action="/payment/qrisPaymentForm" method="POST" modelAttribute="transfer">								
