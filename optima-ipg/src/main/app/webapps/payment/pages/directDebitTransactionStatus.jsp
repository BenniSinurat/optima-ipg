    ...
    <main id="content" style="display: none;">
      ...
      <div class="container container-data">
        <div class="alert alert-warning" role="alert">
            <p>Berikut status transaksi anda.</p> 
        </div>
        ...
        <hr class="mt-1">
        <div class="row m-0 justify-content-between">
            <p class="text-uppercase">Invoice ID</p>
            <p style="color: #333;">${invoiceID}</p>
        </div>
        <hr class="mt-1">
        <div class="row m-0 justify-content-between">
        ...
        <div class="row m-0 justify-content-between">
      	...
      	<hr class="mt-0">
        <div class="row m-0 justify-content-between">
            <p class="text-uppercase">Transaction Amount</p>
            <p style="color: #333;">${transactionAmount}</p>
        </div>
        <hr class="mt-0">
        <div class="row m-0 justify-content-between">
            <p class="text-uppercase">Status Transaksi</p>
