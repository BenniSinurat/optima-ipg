  ...
  <body onload="loading()">
    ...
    <main id="content" style="display: none;">
      ...
      <div class="container container-data">
        ...
        <div class="row m-0">
          <h3>Redirecting to merchant page in <span id="countdown">10</span> seconds</h3><br>
        </div>
        <div class="row min-vw-100">
    ...
    function countdown() {
        ...
        if (seconds < 0) {
            ...
            window.location = '${redirectURL}?ticketID=${ticketID}&transactionNumber=${transactionNumber}&status=${status}&msisdn=${msisdn}';
        } else {
