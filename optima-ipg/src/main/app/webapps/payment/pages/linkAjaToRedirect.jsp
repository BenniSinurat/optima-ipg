...
<body onload="document.linkAjaToRedirect.submit();">
	<div>
		<form id="linkAjaToRedirect" name="linkAjaToRedirect" role="form" class="form-horizontal" action="${applink}" method="POST" modelAttribute="transfer">								
