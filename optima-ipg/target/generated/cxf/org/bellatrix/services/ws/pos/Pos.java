...
public interface Pos {
    ...
    @WebResult(name = "doPaymentQRISResponse", targetNamespace = "http://services.bellatrix.org/", partName = "doPaymentQRISResponse")
    public PaymentResponse doPaymentQRIS(
        @WebParam(partName = "headerAuth", mode = WebParam.Mode.INOUT, name = "headerAuth", targetNamespace = "http://services.bellatrix.org/", header = true)
        javax.xml.ws.Holder<Header> headerAuth,
        @WebParam(partName = "doPaymentQRIS", name = "doPaymentQRIS", targetNamespace = "http://services.bellatrix.org/")
        PaymentRequest doPaymentQRIS
    );
    ...
    @WebMethod(action = "loadTerminalByNNSID")
    @WebResult(name = "loadTerminalByNNSIDResponse", targetNamespace = "http://services.bellatrix.org/", partName = "loadTerminalByNNSIDResponse")
    public LoadTerminalByNNSIDResponse loadTerminalByNNSID(
        @WebParam(partName = "headerAuth", mode = WebParam.Mode.INOUT, name = "headerAuth", targetNamespace = "http://services.bellatrix.org/", header = true)
        javax.xml.ws.Holder<Header> headerAuth,
        @WebParam(partName = "loadTerminalByNNSID", name = "loadTerminalByNNSID", targetNamespace = "http://services.bellatrix.org/")
        LoadTerminalByNNSIDRequest loadTerminalByNNSID
    ) throws Exception_Exception;
}
