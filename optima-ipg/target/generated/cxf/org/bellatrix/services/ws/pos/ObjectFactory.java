...
public class ObjectFactory {
    ...
    private final static QName _DoPaymentQRIS_QNAME = new QName("http://services.bellatrix.org/", "doPaymentQRIS");
    ...
    private final static QName _DoPaymentQRISResponse_QNAME = new QName("http://services.bellatrix.org/", "doPaymentQRISResponse");
    ...
    private final static QName _LoadTerminalByNNSIDResponse_QNAME = new QName("http://services.bellatrix.org/", "loadTerminalByNNSIDResponse");
    ...
    private final static QName _LoadTerminalByNNSID_QNAME = new QName("http://services.bellatrix.org/", "loadTerminalByNNSID");
    ...
    /**
     * Create an instance of {@link LoadTerminalByNNSIDResponse }
     * 
     */
    public LoadTerminalByNNSIDResponse createLoadTerminalByNNSIDResponse() {
        return new LoadTerminalByNNSIDResponse();
    }
    ...
    /**
     * Create an instance of {@link LoadTerminalByNNSIDRequest }
     * 
     */
    public LoadTerminalByNNSIDRequest createLoadTerminalByNNSIDRequest() {
        return new LoadTerminalByNNSIDRequest();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.bellatrix.org/", name = "doPaymentQRIS")
    public JAXBElement<PaymentRequest> createDoPaymentQRIS(PaymentRequest value) {
        return new JAXBElement<PaymentRequest>(_DoPaymentQRIS_QNAME, PaymentRequest.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.bellatrix.org/", name = "doPaymentQRISResponse")
    public JAXBElement<PaymentResponse> createDoPaymentQRISResponse(PaymentResponse value) {
        return new JAXBElement<PaymentResponse>(_DoPaymentQRISResponse_QNAME, PaymentResponse.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link LoadTerminalByNNSIDResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://services.bellatrix.org/", name = "loadTerminalByNNSIDResponse")
    public JAXBElement<LoadTerminalByNNSIDResponse> createLoadTerminalByNNSIDResponse(LoadTerminalByNNSIDResponse value) {
        return new JAXBElement<LoadTerminalByNNSIDResponse>(_LoadTerminalByNNSIDResponse_QNAME, LoadTerminalByNNSIDResponse.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link LoadTerminalByNNSIDRequest }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://services.bellatrix.org/", name = "loadTerminalByNNSID")
    public JAXBElement<LoadTerminalByNNSIDRequest> createLoadTerminalByNNSID(LoadTerminalByNNSIDRequest value) {
        return new JAXBElement<LoadTerminalByNNSIDRequest>(_LoadTerminalByNNSID_QNAME, LoadTerminalByNNSIDRequest.class, null, value);
    }
