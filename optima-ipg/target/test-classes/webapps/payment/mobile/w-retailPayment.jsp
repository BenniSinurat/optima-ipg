          ...
          <div class="card">
              <div class="card-header">
                  <div class="row m-0 justify-content-between">
                      <h3 class="judul">Gerai Retail</h3>
                      <img src="assets/img/alfa-indo.png" alt="Alfamart Indomaret">
                  </div>
              </div>
            <div class="card-body">
                <!-- card transfer -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="row m-0 justify-content-between">
                            ...
                            <div class="copy">
                              ...
                              <span class="tooltiptext">Salin ID</span>
                          </div>
                        </div>
                        <hr class="mt-0">
                        <div class="row m-0 justify-content-between">
                ...
                <div class="card card-pembayaran mt-4">
                    <p class="mb-0">Cara Melakukan Pembayaran <a href="#">Lihat Detail</a> </p>
                </div>
            </div>
          </div>
      </div>
